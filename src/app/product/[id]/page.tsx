    ...
    <main className='container mx-auto p-8 min-h-screen bg-background text-foreground'>
      <div className='mb-8'>
        <Link href='/'>
          <Button
            variant='outline'
            className='gap-2 hover:text-orange-600 hover:bg-orange-50 hover:border-orange-200'
          >
            ...
            <CardContent className='p-6'>
              ...
              <div className='grid grid-cols-4 gap-2 mt-4'>
                {product.images.slice(0, 4).map((image, index) => (
                  <div
                    key={index}
                    className='relative aspect-square border border-orange-100 rounded-md overflow-hidden bg-white'
                  >
                    <Image
                      src={image}
